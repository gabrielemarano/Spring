...
public class LoggingAspect {
    ...
    @Before("within(com.gmarano.spring.examples.aspects.business.*)")
    public void logBeforeAllMethoodsInvocation(JoinPoint joinPoint){
        logger.info("Before method: " + joinPoint.getSignature());
    }

    @After("within(com.gmarano.spring.examples.aspects.business.*)")
    ...
    @AfterReturning("within(com.gmarano.spring.examples.aspects.business.*)")
    ...
    @AfterThrowing("within(com.gmarano.spring.examples.aspects.business.*)")
